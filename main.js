...
function block_update(get_image) {
    fabric.Image.fromURL(get_image, function (Img){
        ...
        superhero_raw_image.scaleToWidth(superhero_raw_width),
        superhero_raw_image.scaleToHeight(superhero_raw_height),
...
function my_keydown(e) {
    ...
    if(e.shiftKey == true && keyPress == "80") {
        ...
        superhero_raw_image = + 10;
        document.getElementById("current-width").innerHTML = superhero_raw_image;
        document.getElementById("current-height").innerHTML = superhero_raw_image;
    }
